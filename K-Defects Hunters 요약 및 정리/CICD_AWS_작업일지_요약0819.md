...
| **8/19 (수)** | **Migration 안전배포 AWS 실배포, 전체 리허설 착수**               | **🔄 Migration+로고 배포 완료(PR #53/#54, AWS 검증까지). 공정상태 AGV 즉시점유·조기점유 버그 2건 발견·수정(타임존+상태판정), 검사화면 이미지 로딩 과다요청 완화 — 둘 다 dev/main 병합·2차 AWS 배포 완료(43357e2), SSH/브라우저 최종검증은 8/20으로 이월. 팀원 YOLO 최종모델(22MB) AWS 반영 확인(부하 재테스트 이월). 발표전 테스트 계획 TC-01 착수 중 버그 대응으로 중단<br>>>확인 후 수정완료.**<br> |
| 8/20 (목)     | 발표 자료 🔒코드동결                                        | ⬜                                                                                                                                                                                                                                                                                |
| 8/21 (금)     | 예비일                                                 | ⬜                                                                                                                                                                                                                                                                                |
| 8/22 (토)     | 🎯 발표                                               | ⬜                                                                                                                                                                                                                                                                                |
